...
import { TestimonialSectionLotEtGaronne } from "@/components/testimonial-section-lot-et-garonne"
...
import { Check, MapPin, Phone, FileText } from "lucide-react"
import { Button } from "@/components/ui/button"
import { trackCall } from "@/lib/analytics"

export default function LotEtGaronneClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités en Lot-et-Garonne (47)"
      ...
      <main className="mx-0">
        ...
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-3 md:py-12">
          <div className="absolute inset-0 opacity-20">
            <img
              src="/lot-et-garonne-landscape-hero-background.jpg"
              alt="Paysage du Lot-et-Garonne"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à Agen, Villeneuve-sur-Lot et Marmande. Estimation gratuite
                et déplacement offert dans tout le département du Lot-et-Garonne.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">
                    Déplacement gratuit en Lot-et-Garonne (47) !
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
        ...
        <CategoriesSection departmentName="le Lot-et-Garonne" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="le Lot-et-Garonne" />
        <WhyChooseUsSection departmentName="le Lot-et-Garonne" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="le Lot-et-Garonne" />

        {/* Zone d'intervention - Villes du Lot-et-Garonne */}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1f5c] mb-4 font-[family-name:var(--font-crimson-pro)]">
                Nos Zones d'Intervention en Lot-et-Garonne
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans toutes les villes et communes du département du Lot-et-Garonne pour estimer et
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                {
                  name: "Agen",
                  description: "Préfecture du Lot-et-Garonne",
                  details: "Centre historique, quartiers anciens, agglomération",
                },
                {
                  name: "Villeneuve-sur-Lot",
                  description: "Sous-préfecture",
                  details: "Bastide médiévale, patrimoine historique",
                },
                {
                  name: "Marmande",
                  description: "Sous-préfecture",
                  details: "Centre-ville, quartiers résidentiels",
                },
                {
                  name: "Nérac",
                  description: "Sous-préfecture",
                  details: "Ville d'art et d'histoire, château",
                },
                {
                  name: "Tonneins",
                  description: "Ville importante",
                  details: "Vallée de la Garonne, patrimoine local",
                },
                {
                  name: "Le Passage",
                  description: "Agglomération d'Agen",
                  details: "Zones résidentielles, maisons anciennes",
                },
                {
                  name: "Bon-Encontre",
                  description: "Agglomération d'Agen",
                ...
                },
                {
                  name: "Boé",
                  description: "Agglomération d'Agen",
                  details: "Zones pavillonnaires, patrimoine",
                },
                {
                  name: "Sainte-Livrade-sur-Lot",
                  description: "Vallée du Lot",
                  details: "Centre historique, maisons de caractère",
                },
                {
                  name: "Casteljaloux",
                  description: "Pays d'Albret",
                  details: "Bastide, patrimoine thermal",
                },
                {
                  name: "Fumel",
                  description: "Vallée du Lot",
                  details: "Ville industrielle, quartiers anciens",
                },
                {
                  name: "Aiguillon",
                  description: "Confluent Lot-Garonne",
                  details: "Bastide, patrimoine historique",
                },
              ].map((city, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">
                Et toutes les autres communes du Lot-et-Garonne !
              </h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble du département du Lot-et-Garonne (47) pour estimer vos
        ...
        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="le Lot-et-Garonne" />
        <TestimonialSectionLotEtGaronne />
