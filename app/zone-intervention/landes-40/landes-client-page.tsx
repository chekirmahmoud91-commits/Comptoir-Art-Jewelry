...
import { TestimonialSectionLandes } from "@/components/testimonial-section-landes"
...
export default function LandesClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités dans les Landes (40)"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <main className="mx-0">
        {/* Hero Section adaptée pour Landes */}
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-3 md:py-12">
          <div className="absolute inset-0 opacity-20">
            <Image
              src="/landes-forest-coast-hero-background.jpg"
              alt="Forêt des Landes et côte atlantique - Paysage landais"
              fill
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à Mont-de-Marsan, Dax et Biscarrosse. Estimation gratuite et
                déplacement offert dans tout le département des Landes.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">
                    Déplacement gratuit dans les Landes (40) !
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
        ...
        <CategoriesSection departmentName="les Landes" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="les Landes" />
        <WhyChooseUsSection departmentName="les Landes" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="les Landes" />

        {/* Zone d'intervention - Villes des Landes */}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1f5c] mb-4 font-[family-name:var(--font-crimson-pro)]">
                Nos Zones d'Intervention dans les Landes
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans toutes les villes et communes du département des Landes pour estimer et racheter
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                {
                  name: "Mont-de-Marsan",
                  description: "Préfecture des Landes",
                  details: "Capitale de la Chalosse, patrimoine",
                },
                {
                  name: "Dax",
                  description: "Sous-préfecture",
                  details: "Première station thermale, collections",
                },
                {
                  name: "Biscarrosse",
                  description: "Station balnéaire",
                  details: "Ville lacustre, villas, antiquités",
                },
                {
                  name: "Saint-Paul-lès-Dax",
                  description: "Ville thermale",
                  details: "Résidences, patrimoine local",
                },
                {
                  name: "Tarnos",
                  description: "Ville industrielle",
                  details: "Zone portuaire, propriétés",
                },
                {
                  name: "Capbreton",
                  description: "Station balnéaire",
                  details: "Villas, objets d'art maritimes",
                },
                {
                  name: "Mimizan",
                  description: "Station balnéaire",
                  details: "Ville forestière, collections",
                },
                {
                  name: "Saint-Vincent-de-Tyrosse",
                  description: "Ville du Seignanx",
                  details: "Quartiers résidentiels, antiquités",
                },
                {
                  name: "Parentis-en-Born",
                  description: "Ville pétrolière",
                  details: "Ville lacustre, patrimoine",
                },
                {
                  name: "Aire-sur-l'Adour",
                  description: "Ville historique",
                  details: "Armagnac, propriétés anciennes",
                },
                {
                  name: "Soustons",
                  description: "Ville des lacs",
                  details: "Golf, résidences, collections",
                },
                {
                  name: "Hagetmau",
                  description: "Capitale de la Chalosse",
                  details: "Marché, patrimoine rural",
                },
              ].map((city, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">Et toutes les autres communes des Landes !</h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble du département des Landes (40) pour estimer vos
        ...
        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="les Landes" />
        <TestimonialSectionLandes />
