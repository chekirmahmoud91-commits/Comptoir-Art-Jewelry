...
import { TestimonialSectionCharente } from "@/components/testimonial-section-charente"
...
export default function CharenteClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités en Charente (16)"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <main className="mx-0">
        {/* Hero Section adaptée pour Charente */}
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-5 md:py-16">
          <div className="absolute inset-0">
            <img
              src="/charente-angouleme-hero-background.jpg"
              alt="Paysage de la Charente"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à Angoulême, Cognac et La Rochefoucauld. Estimation gratuite
                et déplacement offert dans tout le département de la Charente.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">Déplacement gratuit en Charente (16) !</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
                    <Check className="w-4 h-4 text-white" />
        ...
        <CategoriesSection departmentName="la Charente" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Charente" />
        <WhyChooseUsSection departmentName="la Charente" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Charente" />

        {/* Zone d'intervention - Villes de la Charente */}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1f5c] mb-4 font-[family-name:var(--font-crimson-pro)]">
                Nos Zones d'Intervention en Charente
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans toutes les villes et communes du département de la Charente pour estimer et
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                {
                  name: "Angoulême",
                  description: "Préfecture de la Charente",
                  details: "Centre historique, quartiers anciens, agglomération",
                  link: "/zone-intervention/charente-16/angouleme",
                },
                {
                  name: "Cognac",
                  description: "Ville du cognac",
                  details: "Patrimoine viticole, maisons de maître, collections",
                  link: "/zone-intervention/charente-16/cognac",
                },
                {
                  name: "Soyaux",
                  description: "Commune limitrophe d'Angoulême",
                  details: "Résidences, quartiers résidentiels",
                },
                {
                  name: "La Rochefoucauld",
                  description: "Cité médiévale",
                  details: "Château, centre historique, antiquités",
                },
                {
                  name: "Confolens",
                  description: "Ville médiévale",
                  details: "Vieux quartiers, patrimoine historique",
                },
                {
                  name: "Barbezieux-Saint-Hilaire",
                  description: "Sous-préfecture",
                  details: "Centre-ville, communes environnantes",
                },
                {
                  name: "Ruffec",
                  description: "Ville du nord Charente",
                  details: "Quartiers anciens, maisons de caractère",
                },
                {
                  name: "Jarnac",
                  description: "Ville des Grandes Maisons de Cognac",
                  details: "Patrimoine viticole, collections privées",
                },
                {
                  name: "Châteauneuf-sur-Charente",
                  description: "Commune viticole",
                  details: "Centre historique, propriétés anciennes",
                },
                {
                  name: "Saint-Yrieix-sur-Charente",
                  description: "Commune de l'agglomération",
                  details: "Quartiers résidentiels, maisons anciennes",
                },
                {
                  name: "Gond-Pontouvre",
                  description: "Ville de l'agglomération angoumoisine",
                  details: "Zones résidentielles, patrimoine local",
                },
                {
                  name: "Roullet-Saint-Estèphe",
                  description: "Commune du sud Charente",
                  details: "Villages, propriétés rurales",
                },
              ].map((city, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">Et toutes les autres communes de la Charente !</h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble du département de la Charente (16) pour estimer vos
        ...
        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Charente" />
        <TestimonialSectionCharente />
