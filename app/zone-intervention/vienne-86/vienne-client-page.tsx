...
import TestimonialSectionVienne from "@/components/testimonial-section-vienne"
...
export default function VienneClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités dans la Vienne (86)"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <main className="mx-0">
        {/* Hero Section adaptée pour Vienne */}
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-3 md:py-12">
          <div className="absolute inset-0 opacity-20">
            <img
              src="/vienne-poitiers-hero-background.jpg"
              alt="Vienne - Poitiers"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à Poitiers, Châtellerault et Loudun. Estimation gratuite et
                déplacement offert dans tout le département de la Vienne.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">
                    Déplacement gratuit dans la Vienne (86) !
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
        ...
        <CategoriesSection departmentName="la Vienne" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Vienne" />
        <WhyChooseUsSection departmentName="la Vienne" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Vienne" />

        {/* Zone d'intervention - Villes de la Vienne */}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans toutes les villes et communes du département de la Vienne pour estimer et racheter
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                {
                  name: "Poitiers",
                  description: "Préfecture de la Vienne",
                ...
                {
                  name: "Montmorillon",
                  description: "Ville de la Gartempe",
                  details: "Quartiers anciens, maisons de caractère",
                },
                {
                  name: "Civray",
                  description: "Commune du sud",
                  details: "Patrimoine local, antiquités",
                },
                {
                  name: "Chauvigny",
                  description: "Cité médiévale",
                  details: "Centre historique, collections",
                },
                {
                  name: "Jaunay-Marigny",
                  description: "Commune du Futuroscope",
                ...
                },
                {
                  ...
                  details: "Centre ancien, patrimoine",
                },
                {
                  name: "Mirebeau",
                  description: "Ville du nord",
                  details: "Quartiers historiques, objets d'art",
                },
                {
                  name: "Lusignan",
                  description: "Cité historique",
                  details: "Patrimoine médiéval, collections",
                },
              ].map((city, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">Et toutes les autres communes de la Vienne !</h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble du département de la Vienne (86) pour estimer vos
        ...
        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Vienne" />
        <TestimonialSectionVienne />
