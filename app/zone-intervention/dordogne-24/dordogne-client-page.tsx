...
import { TestimonialSectionDordogne } from "@/components/testimonial-section-dordogne"
...
export default function DordogneClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités en Dordogne (24)"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <main className="mx-0">
        {/* Hero Section adaptée pour Dordogne */}
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-3 md:py-12">
          <div className="absolute inset-0 opacity-20">
            <img
              src="/dordogne-perigueux-hero-background.jpg"
              alt="Périgueux - Dordogne"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à Périgueux, Bergerac et Sarlat. Estimation gratuite et
                déplacement offert dans tout le département de la Dordogne.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">Déplacement gratuit en Dordogne (24) !</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
                    <Check className="w-4 h-4 text-white" />
        ...
        <CategoriesSection departmentName="la Dordogne" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Dordogne" />
        <WhyChooseUsSection departmentName="la Dordogne" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Dordogne" />

        {/* Zone d'intervention - Villes de la Dordogne */}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1f5c] mb-4 font-[family-name:var(--font-crimson-pro)]">
                Nos Zones d'Intervention en Dordogne
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans toutes les villes et communes du département de la Dordogne pour estimer et
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                {
                  name: "Périgueux",
                  description: "Préfecture de la Dordogne",
                  details: "Centre historique, quartiers anciens, patrimoine",
                },
                {
                  name: "Bergerac",
                  description: "Sous-préfecture",
                  details: "Ville viticole, vieille ville, collections",
                },
                {
                  name: "Sarlat-la-Canéda",
                  description: "Sous-préfecture",
                  details: "Capitale du Périgord Noir, patrimoine médiéval",
                },
                {
                  name: "Nontron",
                  description: "Sous-préfecture",
                  details: "Périgord Vert, artisanat, antiquités",
                },
                {
                  name: "Ribérac",
                  description: "Ville du Périgord Blanc",
                  details: "Marché, propriétés, collections",
                },
                {
                  name: "Terrasson-Lavilledieu",
                  description: "Porte du Périgord Noir",
                  details: "Patrimoine, maisons anciennes",
                },
                {
                  name: "Montpon-Ménestérol",
                  description: "Ville de la Double",
                  details: "Zone résidentielle, antiquités",
                },
                {
                  name: "Coulounieix-Chamiers",
                  description: "Agglomération de Périgueux",
                  details: "Quartiers résidentiels, patrimoine",
                },
                {
                  name: "Trélissac",
                  description: "Commune périurbaine",
                  details: "Propriétés, maisons de caractère",
                },
                {
                  name: "Boulazac",
                  description: "Zone industrielle",
                  details: "Résidences, collections privées",
                },
                {
                  name: "Le Bugue",
                  description: "Capitale de la préhistoire",
                  details: "Patrimoine, objets anciens",
                },
                {
                  name: "Thiviers",
                  description: "Capitale du foie gras",
                  details: "Marché, propriétés rurales",
                },
              ].map((city, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">Et toutes les autres communes de la Dordogne !</h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble du département de la Dordogne (24) pour estimer vos
        ...
        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Dordogne" />
        <TestimonialSectionDordogne />
