...
import TestimonialSectionHauteVienne from "@/components/testimonial-section-haute-vienne"
...
export default function HauteVienneClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités en Haute-Vienne (87)"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <main className="mx-0">
        {/* Hero Section adaptée pour Haute-Vienne */}
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-5 md:py-16">
          <div className="absolute inset-0 opacity-20">
            <img
              src="/haute-vienne-limoges-hero-background.jpg"
              alt="Haute-Vienne - Limoges"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="lg:text-6xl font-bold font-[family-name:var(--font-crimson-pro)] md:text-4xl text-3xl mt-3.5 mb-3.5">
                {displayedText}
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à Limoges, Saint-Junien et Bellac. Estimation gratuite et
                déplacement offert dans tout le département de la Haute-Vienne.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">
                    Déplacement gratuit en Haute-Vienne (87) !
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
        ...
        <CategoriesSection departmentName="la Haute-Vienne" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Haute-Vienne" />
        <WhyChooseUsSection departmentName="la Haute-Vienne" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Haute-Vienne" />

        {/* Zone d'intervention - Villes de la Haute-Vienne */}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1f5c] mb-4 font-[family-name:var(--font-crimson-pro)]">
                Nos Zones d'Intervention en Haute-Vienne
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans toutes les villes et communes du département de la Haute-Vienne pour estimer et
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                {
                  name: "Limoges",
                  description: "Préfecture de la Haute-Vienne",
                  details: "Centre historique, quartiers anciens, patrimoine",
                },
                {
                  name: "Saint-Junien",
                  description: "Sous-préfecture",
                  details: "Ville historique, collections, antiquités",
                },
                {
                  name: "Bellac",
                  description: "Sous-préfecture",
                  details: "Centre ancien, patrimoine, objets d'art",
                },
                {
                  name: "Rochechouart",
                  description: "Commune historique",
                  details: "Château, patrimoine, collections",
                },
                {
                  name: "Saint-Yrieix-la-Perche",
                  description: "Ville du sud",
                  details: "Centre ancien, antiquités",
                },
                {
                  name: "Panazol",
                  description: "Commune de l'agglomération",
                  details: "Zones résidentielles, propriétés",
                },
                {
                  name: "Couzeix",
                  description: "Ville de l'agglomération",
                ...
                },
                {
                  ...
                  description: "Ville de la Vienne",
                  details: "Centre historique, objets d'art",
                },
                {
                  name: "Ambazac",
                  description: "Commune des Monts",
                  details: "Patrimoine rural, collections",
                },
                {
                  name: "Eymoutiers",
                  description: "Ville de la Vienne",
                ...
                },
                {
                  ...
                  details: "Patrimoine local, objets anciens",
                },
              ].map((city, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">
                Et toutes les autres communes de la Haute-Vienne !
              </h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble du département de la Haute-Vienne (87) pour estimer vos
        ...
        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Haute-Vienne" />
        <TestimonialSectionHauteVienne />
