...
export default function MerignacClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités à Mérignac (33)"
      ...
      <main className="mx-0">
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-3 md:py-12">
          <div className="absolute inset-0">
            <img
              src="/merignac-parc-bourran-hero-background.jpg"
              alt="Parc du Bourran à Mérignac"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à Mérignac. Estimation gratuite et déplacement offert dans
                tous les quartiers de la deuxième ville de Gironde.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">
                    Déplacement gratuit à Mérignac et ses environs !
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
        ...
        <CategoriesSection departmentName="Mérignac" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Mérignac" />
        <WhyChooseUsSection departmentName="Mérignac" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Mérignac" />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1f5c] mb-4 font-[family-name:var(--font-crimson-pro)]">
                Nos Zones d'Intervention à Mérignac
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans tous les quartiers de Mérignac pour estimer et racheter vos objets d'art,
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                {
                  name: "Centre-Ville",
                  description: "Cœur administratif de Mérignac",
                  details: "Hôtel de Ville, Place Charles de Gaulle",
                },
                {
                  name: "Arlac",
                  description: "Quartier résidentiel au sud",
                  details: "Villas, maisons familiales",
                },
                {
                  name: "Beaudésert",
                  description: "Zone pavillonnaire et commerciale",
                  details: "Commerces, résidences",
                },
                {
                  name: "Bourranville",
                  description: "Secteur du Parc du Bourran",
                  details: "Cadre verdoyant, propriétés",
                },
                {
                  name: "Capeyron",
                  description: "Quartier résidentiel à l'ouest",
                  details: "Zone calme, maisons individuelles",
                },
                {
                  name: "Chemin Long",
                ...
                {
                  name: "Mérignac-Soleil",
                  description: "Grand ensemble au nord",
                  details: "Résidences, commerces de proximité",
                },
                {
                  name: "Quatre Chemins",
                  description: "Secteur commercial et résidentiel",
                  details: "Centre commercial, appartements",
                },
                {
                  name: "Yser",
                  description: "Quartier proche de l'aéroport",
                  details: "Zone résidentielle et d'activités",
                },
              ].map((quartier, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">
                Et tous les autres quartiers de Mérignac et ses environs !
              </h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble de Mérignac et ses environs pour estimer vos
        ...
        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Mérignac" />
