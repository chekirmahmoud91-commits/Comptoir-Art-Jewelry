...
export default function PessacClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités à Pessac (33)"
      ...
      <main className="mx-0">
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-3 md:py-12">
          <div className="absolute inset-0">
            <img
              src="/pessac-chateau-pape-clement-hero-background.jpg"
              alt="Château Pape Clément à Pessac"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à Pessac. Estimation gratuite et déplacement offert dans tous
                les quartiers : Alouette-Bersol, Monteil, Cap de Bos, Châtaigneraie et toute la ville.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">
                    Déplacement gratuit à Pessac et ses environs !
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
        ...
        <CategoriesSection departmentName="Pessac" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Pessac" />
        <WhyChooseUsSection departmentName="Pessac" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Pessac" />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1f5c] mb-4 font-[family-name:var(--font-crimson-pro)]">
                Nos Zones d'Intervention à Pessac
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans tous les quartiers de Pessac pour estimer et racheter vos objets d'art,
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                {
                  name: "Alouette-Bersol",
                  description: "Quartier résidentiel prisé",
                  details: "Demeures bourgeoises, patrimoine ancien",
                },
                {
                  name: "Monteil",
                  description: "Quartier calme et verdoyant",
                  details: "Maisons de caractère, collections privées",
                },
                {
                  name: "Cap de Bos",
                  description: "Zone verte et résidentielle",
                  details: "Propriétés de caractère, antiquités",
                },
                {
                  name: "Châtaigneraie",
                  description: "Quartier familial",
                  details: "Maisons anciennes, meubles de famille",
                },
                {
                  name: "Saige",
                  description: "Secteur dynamique",
                  details: "Patrimoine varié, objets d'art",
                },
                {
                  name: "Centre-ville",
                  description: "Cœur historique de Pessac",
                  details: "Immeubles anciens, antiquités",
                },
                {
                  name: "Haut-Livrac",
                  description: "Quartier résidentiel",
                  details: "Villas, collections de valeur",
                },
                {
                  name: "Brivazac",
                  description: "Zone pavillonnaire",
                  details: "Belles propriétés, meubles anciens",
                },
                {
                  name: "Noès",
                  description: "Quartier verdoyant",
                  details: "Maisons de caractère, patrimoine",
                },
                {
                  name: "Bellegrave",
                  description: "Secteur résidentiel",
                  details: "Propriétés anciennes, antiquités",
                },
                {
                  name: "Magonty",
                  description: "Quartier familial",
                  details: "Maisons traditionnelles, collections",
                },
                {
                  name: "Candau",
                  description: "Zone résidentielle",
                  details: "Patrimoine familial, objets d'art",
                },
              ].map((quartier, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">
                Et tous les autres quartiers de Pessac et ses environs !
              </h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble de Pessac et ses environs pour estimer vos antiquités,
                objets d'art, meubles anciens et collections.
              </p>
            </div>
          </div>
        </section>

        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Pessac" />
