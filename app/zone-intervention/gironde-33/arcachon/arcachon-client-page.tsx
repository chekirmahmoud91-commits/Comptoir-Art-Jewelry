...
export default function ArcachonClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités à Arcachon (33)"
      ...
      <main className="mx-0">
        ...
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-3 md:py-12">
          <div className="absolute inset-0 opacity-20">
            <Image
              src="/arcachon-ville-hiver-hero-background.jpg"
              alt="Ville d'Hiver Arcachon"
              fill
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à Arcachon. Intervention dans la Ville d'Hiver, le
                centre-ville et tous les quartiers. Estimation gratuite et déplacement offert.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">Déplacement gratuit à Arcachon !</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
                    <Check className="w-4 h-4 text-white" />
                  </div>
                  <p className="text-gray-200 text-left text-sm">Spécialiste villas anciennes !</p>
                </div>
              </div>
        ...
        <CategoriesSection departmentName="Arcachon" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Arcachon" />
        <WhyChooseUsSection departmentName="Arcachon" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Arcachon" />

        {/* Quartiers d'Arcachon */}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1f5c] mb-4 font-[family-name:var(--font-crimson-pro)]">
                Nos Zones d'Intervention à Arcachon
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans tous les quartiers d'Arcachon pour estimer et racheter vos objets d'art,
              ...
              {[
                {
                  ...
                  details: "Villas Belle Époque, patrimoine architectural",
                },
                {
                  name: "Ville d'Été",
                  description: "Centre-ville",
                  details: "Front de mer, commerces, résidences",
                },
                {
                  name: "Ville de Printemps",
                  description: "Quartier résidentiel",
                  details: "Villas, propriétés de caractère",
                },
                {
                  name: "Ville d'Automne",
                  description: "Quartier calme",
                  details: "Maisons anciennes, jardins",
                },
                {
                  name: "Pereire",
                  description: "Quartier balnéaire",
                  details: "Villas en bord de mer",
                },
                {
                  name: "Les Abatilles",
                  description: "Quartier résidentiel",
                  details: "Propriétés, maisons de famille",
                },
              ].map((quartier, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">
                Et tous les autres quartiers d'Arcachon et du Bassin !
              </h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble d'Arcachon et du Bassin d'Arcachon pour estimer vos
                antiquités, objets d'art, meubles anciens et collections de villas Belle Époque.
              </p>
            </div>
          </div>
        </section>

        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Arcachon" />
