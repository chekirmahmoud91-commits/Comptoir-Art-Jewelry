...
export default function TalenceClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités à Talence (33)"
      ...
      <main className="mx-0">
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-3 md:py-12">
          <div className="absolute inset-0">
            <img
              src="/talence-campus-universitaire-hero-background.jpg"
              alt="Campus universitaire de Talence"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à Talence. Estimation gratuite et déplacement offert dans
                tous les quartiers : Thouars, Peixotto, Forum, Médoquine et toute la ville.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">
                    Déplacement gratuit à Talence et ses environs !
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
        ...
        <CategoriesSection departmentName="Talence" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Talence" />
        <WhyChooseUsSection departmentName="Talence" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Talence" />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1f5c] mb-4 font-[family-name:var(--font-crimson-pro)]">
                Nos Zones d'Intervention à Talence
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans tous les quartiers de Talence pour estimer et racheter vos objets d'art,
              ...
              {[
                {
                  ...
                  details: "Campus, patrimoine architectural",
                },
                {
                  name: "Peixotto",
                  description: "Zone résidentielle prisée",
                  details: "Belles propriétés, collections privées",
                },
                {
                  name: "Forum",
                  description: "Centre-ville de Talence",
                  details: "Commerces, immeubles anciens",
                },
                {
                  name: "Médoquine",
                ...
                {
                  name: "Raba",
                  description: "Secteur verdoyant",
                  details: "Propriétés résidentielles, patrimoine",
                },
                {
                  name: "Barrière de Toulouse",
                  description: "Quartier historique",
                  details: "Proche Bordeaux, immeubles anciens",
                },
                {
                  name: "Gambetta",
                  description: "Zone commerçante",
                  details: "Résidences, collections de valeur",
                },
                {
                  name: "Haut-Brion",
                  description: "Quartier prestigieux",
                  details: "Vignobles, propriétés de standing",
                },
                {
                  name: "Bois de Thouars",
                  description: "Zone verte",
                  details: "Propriétés de standing, antiquités",
                },
                {
                  name: "Suzon",
                  description: "Quartier résidentiel",
                  details: "Maisons familiales, meubles anciens",
                },
                {
                  name: "Béthanie",
                  description: "Secteur calme",
                  details: "Propriétés anciennes, collections",
                },
                {
                  name: "Liberté",
                  description: "Zone résidentielle",
                  details: "Immeubles, objets d'art",
                },
              ].map((quartier, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">
                Et tous les autres quartiers de Talence et ses environs !
              </h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble de Talence et ses environs pour estimer vos antiquités,
        ...
        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="Talence" />
