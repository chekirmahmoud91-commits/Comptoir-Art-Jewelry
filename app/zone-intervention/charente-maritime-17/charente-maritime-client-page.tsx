...
import { TestimonialSectionCharenteMaritime } from "@/components/testimonial-section-charente-maritime"
...
export default function CharenteMaritimeClientPage() {
  const [isModalOpen, setIsModalOpen] = useState(false)
  const [displayedText, setDisplayedText] = useState("")
  const fullText = "Rachat d'Antiquités en Charente-Maritime (17)"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <main className="mx-0">
        {/* Hero Section adaptée pour Charente-Maritime */}
        <section className="relative bg-gradient-to-br from-[#1a1f5c] via-[#252b6e] to-[#1a1f5c] text-white overflow-hidden py-5 md:py-16">
          <div className="absolute inset-0 opacity-20">
            <img
              src="/charente-maritime-la-rochelle-hero-background.jpg"
              alt="La Rochelle - Charente-Maritime"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="md:text-2xl text-gray-200 mb-8 text-justify text-base">
                Expert agréé en objets d'art et antiquités à La Rochelle, Rochefort et Saintes. Estimation gratuite et
                déplacement offert dans tout le département de la Charente-Maritime.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-3xl mx-auto mb-8 text-base">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-gray-200 text-left text-sm md:text-sm">
                    Déplacement gratuit en Charente-Maritime (17) !
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#C4A053] flex items-center justify-center flex-shrink-0">
        ...
        <CategoriesSection departmentName="la Charente-Maritime" />
        <AboutSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Charente-Maritime" />
        <WhyChooseUsSection departmentName="la Charente-Maritime" />
        <ProcessSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Charente-Maritime" />

        {/* Zone d'intervention - Villes de la Charente-Maritime */}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1f5c] mb-4 font-[family-name:var(--font-crimson-pro)]">
                Nos Zones d'Intervention en Charente-Maritime
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto text-justify">
                Nous intervenons dans toutes les villes et communes du département de la Charente-Maritime pour estimer
                et racheter vos objets d'art et antiquités.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                {
                  name: "La Rochelle",
                  description: "Préfecture de la Charente-Maritime",
                  details: "Centre historique, Vieux Port, patrimoine maritime",
                },
                {
                  name: "Rochefort",
                  description: "Sous-préfecture",
                  details: "Arsenal, ville d'art et d'histoire, collections",
                },
                {
                  name: "Saintes",
                  description: "Sous-préfecture",
                  details: "Ville d'art et d'histoire, patrimoine romain",
                },
                {
                  name: "Royan",
                  description: "Station balnéaire",
                  details: "Architecture années 50, villas, patrimoine",
                },
                {
                  name: "Marennes",
                  description: "Commune ostréicole",
                  details: "Patrimoine maritime, propriétés anciennes",
                },
                {
                  name: "Jonzac",
                  description: "Sous-préfecture",
                ...
                },
                {
                  ...
                  description: "Sous-préfecture",
                  details: "Abbaye royale, patrimoine historique",
                },
                {
                  name: "Pons",
                  description: "Ville historique",
                  details: "Donjon, patrimoine médiéval, collections",
                },
                {
                  name: "Surgères",
                  description: "Commune historique",
                  details: "Château, quartiers anciens, antiquités",
                },
                {
                  name: "Tonnay-Charente",
                  description: "Ville portuaire",
                  details: "Patrimoine fluvial, maisons de caractère",
                },
                {
                  name: "Saujon",
                  description: "Station thermale",
                  details: "Villas anciennes, patrimoine thermal",
                },
                {
                  name: "Châtelaillon-Plage",
                  description: "Station balnéaire",
                  details: "Villas Belle Époque, patrimoine balnéaire",
                },
              ].map((city, index) => (
                <div
                  key={index}
            ...
            <div className="text-center bg-gradient-to-r from-[#1a1f5c]/5 via-[#C4A053]/5 to-[#1a1f5c]/5 rounded-xl p-8 border-2 border-[#C4A053]/20 pb-2.5">
              <h3 className="text-2xl font-bold text-[#1a1f5c] mb-4">
                Et toutes les autres communes de la Charente-Maritime !
              </h3>
              <p className="text-gray-700 text-lg mb-6 text-justify">
                Nous nous déplaçons gratuitement dans l'ensemble du département de la Charente-Maritime (17) pour
                estimer vos antiquités, objets d'art, meubles anciens et collections.
              </p>
            </div>
          </div>
        </section>

        <ExpertSection onEstimationClick={() => setIsModalOpen(true)} departmentName="la Charente-Maritime" />
        <TestimonialSectionCharenteMaritime />
