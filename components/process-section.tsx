...
export function ProcessSection({ onEstimationClick, departmentName = "la Nouvelle-Aquitaine" }: ProcessSectionProps) {
  const steps = [
    {
      number: 1,
    ...
    },
    {
      ...
      description: `Si vous souhaitez vendre, nous venons examiner et récupérer l'objet chez vous, sans frais, dans ${departmentName}.`,
    },
    {
      number: 3,
          ...
          {steps.map((step, index) => (
            <div key={step.number} className="flex gap-6">
              <div className="flex-shrink-0">
                ...
                <div className="w-1 h-20 bg-gray-400 mx-auto mt-2" />
              </div>
