...
interface ExpertSectionGirondeProps {
  onEstimationClick: () => void
}

export function ExpertSectionGironde({ onEstimationClick }: ExpertSectionGirondeProps) {
  return (
    <section className="container mx-auto px-4 md:py-5 py-5">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 ml-5">
          <p className="text-sm text-gray-500">Rachat d'objets d'art dans la Gironde !</p>
