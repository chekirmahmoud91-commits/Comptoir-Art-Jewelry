...
export function AboutSection({ onEstimationClick, departmentName = "la Nouvelle-Aquitaine" }: AboutSectionProps) {
  return (
    <section id="about" className="bg-gray-50 py-5 md:py-5">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed text-justify">
          {`Un vieux tableau, une commode, une montre, un instrument de musique... oubliés chez vous depuis des années ?\nNous sommes spécialisés dans l'achat d'objets d'art et d'antiquités.\nNous vous proposons une estimation gratuite et un rachat immédiat au meilleur prix.\nDéplacement gratuit dans ${departmentName}.`}
        </p>
