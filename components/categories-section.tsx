      ...
      <div className="aspect-video overflow-hidden bg-gray-100 relative">
        {category.items.map((item, idx) => (
          <img
            ...
            alt={`${item.name} - Achat et estimation d'objets anciens en Nouvelle-Aquitaine`}
...
export function CategoriesSection({ departmentName = "la Nouvelle-Aquitaine" }: { departmentName?: string }) {
  return (
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-justify">
            {`Spécialisés dans l'achat d'objets anciens, nous intervenons dans ${departmentName} pour estimer et racheter vos biens.`}
          </p>
        </div>
